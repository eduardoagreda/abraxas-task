...
class TaskApiTest(TestCase):
    ...
    def setUp(self):
        ...
        self.task_one = Task.objects.create(description='Task 1', date_task='2021-02-18', status=1, duration=45)
        self.task_two = Task.objects.create(description='Task 2', date_task='2021-02-19', status=2, duration=90, total_time='01:15:00')

        self.payload_task_complete = {
            'description': 'Task 1',
            'date_task': '2021-02-18',
            'status': 2,
            'duration': 90,
            'total_time': '01:30:00'
        }
    ...
    def test_retrive_tasks_list(self):
        Task.objects.create(description='Test 1', date_task='2021-02-17', status=1, duration=45, total_time='00:35:00')
        Task.objects.create(description='Test 2', date_task='2021-02-18', status=2, duration=90, total_time='01:30:00')
